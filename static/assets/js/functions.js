...
$( document ).ready(function() {
  ...
  function workSlider2() {
    ...
    $('.slider2--prev, .slider2--next').click(function() {
      ...
      var $this = $(this),
          curLeft = $('.slider2').find('.slider--item-left'),
          curLeftPos = $('.slider2').children().index(curLeft),
          curCenter = $('.slider2').find('.slider--item-center'),
          curCenterPos = $('.slider2').children().index(curCenter),
          curRight = $('.slider2').find('.slider--item-right'),
      ...
      if ($this.hasClass('slider2--next')) {
        if (curLeftPos < totalWorks - 1 && curCenterPos < totalWorks - 1 && curRightPos < totalWorks - 1) {
          ...
          $right.removeClass('slider--item-right').next().addClass('slider2--item-right');
        }
        else {
          if (curLeftPos === totalWorks - 1) {
